...
|.                                                                                  Corrija o código levando em base:                              Corrija a descrição do PR. Ela fala em venda rápida com TypeScript, Jest e VendaRapidaService, enquanto a branch entrega
somente um guia de identidade visual.

Confira os ativos de marca já presentes no repositório e liste os arquivos encontrados. O guia diz que a logo ainda será
fornecida, mas a aplicação já usa imagens da marca. Indique o que está aprovado e o que ainda depende de confirmação.

Revise a paleta e a tipografia à luz dos protótipos e Views atuais. Não apresente cores como “oficiais” sem registrar de
onde veio essa decisão. Inclua a verificação de contraste, já que o cartão a exige.

Enxugue o guia e alinhe os exemplos ao sistema. O cartão pede um guia curto para orientar protótipos e Views. O exemplo
atual mistura a navegação de lojista e vendedor e usa produtos eletrônicos, enquanto nosso domínio é estoque de calçados.
Mantenha a separação por perfil e o padrão ASP.NET Core MVC. Organize o documento em docs/05-ux/.

Antes de cada nova alteração, atualize sua branch com a main mais recente — faça o pull/fetch da main e incorpore essas
mudanças à sua branch. Faça essa conferência novamente antes de enviar o PR para revisão. Dar git pull apenas em dev/nicolas
não traz, por si só, as mudanças da main.
