...
> **Base Estrutural / Esqueleto:** `MvcMovie` (ASP.NET Core MVC oficial)  
...
O projeto **não é construído do zero**. Ele aproveita o projeto `MvcMovie` como esqueleto e base arquitetural, substituindo integralmente o domínio de *Filmes* pelo domínio de *Estoque de Calçados*.
...
| :--- | :--- | :--- | :--- |
| **DA-01** | **Esqueleto do Projeto** | O projeto `MvcMovie` é a base estrutural e tecnológica direta. | Aproveitamento do scaffolding, tooling e configuração já existente e testada. |
